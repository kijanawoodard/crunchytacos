<form action="<?php echo FrontController::urlFor('install/settings');?>" method="post">
	<fieldset>
		...
		<input type="hidden" value="<?php echo(empty($configuration->db_type) ? 'MySql' : $configuration->db_type);?>" name="db_type" />		
	</fieldset>
</form>