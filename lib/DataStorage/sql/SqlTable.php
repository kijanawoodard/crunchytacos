<?php
	class_exists('SqlColumn') || require('lib/DataStorage/sql/SqlColumn.php');
	class_exists('SqlKey') || require('lib/DataStorage/sql/SqlKey.php');
	class SqlTable{
		public $name;
		public $columns;
		public $keys;
		...
		public function addColumn($name, $type, $options){
			$this->columns[] = new SqlColumn($name, $type, $options);
		}
		public function addKey($type, $options){
			$this->keys[] = new SqlKey($type, $options);
		}
		...
		public function get_add_column_sql($name, $type, $options){
			...
			$column = new SqlColumn($name, $type, $options);
			$sql .= $column->getSql();
			return $sql;
		}
